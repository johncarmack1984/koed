...
temporary plaintext file. Operators should create and destroy the disposable
target database outside this command so database ownership, networking,
encryption, and access controls match the deployment environment being tested.
