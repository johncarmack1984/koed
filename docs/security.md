...
The console uses an HTTP-only session cookie. Codex and MCP clients use bearer API tokens. Store generated API tokens immediately; only token prefixes are listed later.
